...
const NotifReportList = ({leave_requests, departmentIdToName, employeeIdToName, leaveTypeIdToName}) => {
    ...
    return (
        <div>
            ...
            <caption>{leave_requests && leave_requests.length} Leave history</caption>
                <thead>
                    <tr>
                        <th>Emp. Name</th>
                        <th>Department</th>
